...
pwd2_27_64bits=/mnt/e/Linux/Pwn/glibc-all-in-one/libs/2.27-3ubuntu1.6_amd64

pwd2_23_32bits=/mnt/e/Linux/Pwn/glibc-all-in-one/libs/2.23-0ubuntu11.3_i386
pwd2_27_32bits=/mnt/e/Linux/Pwn/glibc-all-in-one/libs/2.27-3ubuntu1.6_i386
...
if test -e ../${input};then
  if test $glibc = "2.23";then
    if test $bits = "64";then
      ...
      echo "Please give bits message" > /dev/fd/2
      exit 1
    fi
